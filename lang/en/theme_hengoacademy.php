...
$string['choosereadme'] = 'Theme hengoacademy is a child theme of Boost. It adds the ability to upload background photos.';
// Name of the settings pages.
$string['configtitle'] = 'hengoacademy settings';
...
$string['pluginname'] = 'HENGO ACADEMY';
