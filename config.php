...
// extensions.
$THEME->sheets = array('hengoacademy');


$THEME->javascripts_footer = array('hengoacademy');
...
$THEME->scss = function($theme) {
    return theme_hengoacademy_get_main_scss_content($theme);
    //return theme_boost_get_main_scss_content($theme);
};
$THEME->prescsscallback = 'theme_hengoacademy_get_pre_scss';
